...
def setup_logger(logger_name):
  ...
  Allows for colored messages using the `extra` argument.
  """
...
def log_success(logger, message):
  ...
  logger.info(message, extra={'levelname': 'SUCCESS'})

def log_failed(logger, message):
  """Logs a failed message with a red color."""
  logger.info(message, extra={'levelname': 'FAILED'})

def log_warning(logger, message):
  """Logs a warning message with an orange color."""
  logger.warning(message, extra={'levelname': 'WARNING'})
